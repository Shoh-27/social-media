...
<div class="w-full max-w-md">
    ...
    <div class="text-center mb-8">
        <h1 class="text-4xl font-bold text-white mb-2">Social</h1>
        <p class="text-blue-100">Join our community today</p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-2xl p-8">
        ...
        <form method="POST" action="{{ route('register') }}" x-data="registerForm()">
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    ...
                    <input
                        ...
                        x-model="username"
                        @input="checkUsername"
                        class="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition @error('username') border-red-500 @enderror"
                        placeholder="johndoe">
                </div>
                <p class="mt-1 text-xs text-gray-500">Only letters, numbers and underscore</p>
                @error('username')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror

                <!-- Username Availability Check -->
                <div x-show="usernameStatus !== null" class="mt-2">
                    <p x-show="usernameStatus === 'available'" class="text-sm text-green-600 flex items-center">
                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                        </svg>
                        Username available
                    </p>
                    <p x-show="usernameStatus === 'taken'" class="text-sm text-red-600 flex items-center">
                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/>
                        </svg>
            ...
            <div class="mb-4">
                ...
                <div class="mt-2">
                    <div class="flex space-x-1">
                        ...
                        <div class="h-2 flex-1 rounded" :class="passwordStrength >= 3 ? 'bg-blue-500' : 'bg-gray-200'"></div>
                        <div class="h-2 flex-1 rounded" :class="passwordStrength >= 4 ? 'bg-green-500' : 'bg-gray-200'"></div>
                    </div>
            ...
            <button
                type="submit"
                class="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 rounded-lg font-semibold hover:from-blue-600 hover:to-purple-700 transition duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                Create Account
            </button>
        </form>
    ...
    <div class="mt-6">
        ...
        <div class="mt-6 grid grid-cols-2 gap-3">
            <button class="w-full bg-white text-gray-700 border border-gray-300 rounded-lg px-4 py-3 hover:bg-gray-50 transition flex items-center justify-center">
        ...
        return {
            ...
            checkUsername() {
                ...
                this.usernameTimeout = setTimeout(async () => {
                    // Check username availability (optional - needs API endpoint)
                    // For now, just validate format
                    const isValid = /^[a-zA-Z0-9_]+$/.test(this.username);
                    this.usernameStatus = isValid ? 'available' : 'taken';
                }, 500);
            },
